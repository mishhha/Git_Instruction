...
HEAD является и ссылкой на последний коммит. Эту команду можно использовать при вводе команд в терминале.

### Логи
Логи это выжимка основной информации о том, что происходило с файлом. Лог содержит хеш индентификатор. Имя, почту, дату и комментарий произведенного коммита.
...
Что бы выйти из меню с логами, необходимо нажать букву - Q 

### Статусы файлов

untracked - значит в этом файле не отслеживаются изменения, для его отслеживания необходимо перевести в статус staged командой git add "имя файла" 
staged - файл подготовлен к отслеживанию, теперь изменения в нем будут отслеживаться. Что бы файл попал в этот статус необходимо добавить его. 
tracked - противоположность untracked, означает, что файл отслеживается. При изменениях в файле укажет их статус.
modified - файл модифицирован, для записи изменений необходимо записать его в staged командой git add "имя файла".
